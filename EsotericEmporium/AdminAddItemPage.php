...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    {
        //generate a unique idea in a dumb way because MySQL is being lame
        $idInUse = true;

        do{
            $id = rand(10000,99999);

            $itemStatement = $pdo->query("SELECT * FROM Item WHERE Item.itemId = $id;");
            $itemStatement->setFetchMode(PDO::FETCH_ASSOC);

            $currentItemData = $itemStatement->fetch();
        ...
        $pdo->query( "INSERT INTO Item(itemID, itemName, itemDescription, itemPrice, itemImageName) VALUES ($id, '$name', '$description', $price, '$filename')");
        header("Location: AdminItemPage.php");
        exit;
    }
}
...
<html>
    ...
    <body>
        ...
        <form method="POST" action="AdminAddItemPage.php" enctype="multipart/form-data">  
        <h2>New Item</h2>
        <table>
            <tr>
                <th class="slim">
                ...
                <td class="slim"> 
                <p> <textarea rows="1" cols="100" name="name">Item</textarea></p>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td> 
                    <p> <textarea rows="10" cols="100" name="description">No description.</textarea></p>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td> 
                    <p> <input type="number" name="price" value="99.99"> </p>
                </td>
            </tr>
            <tr>
                <th>
